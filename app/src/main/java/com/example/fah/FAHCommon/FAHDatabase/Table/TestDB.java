...
//    public TestDB(String titlePost, String accountStr, String companyName) {
//        this.titlePost = titlePost;
//        this.accountStr = accountStr;
//        this.companyName = companyName;
//    }

    public TestDB(String titlePost, String companyName, String address, String workingTime, String luong, Date deadLine) {
        this.titlePost = titlePost;
        this.companyName = companyName;
    ...
    public TestDB(String titlePost,
                String companyName,
                String field,
